...
export default function BuildProcess() {
  const steps = [
    ...
    { id: 4, icon: <FileText size={32} />, title: 'เตรียมเอกสารขออนุญาตก่อสร้าง', desc: 'ทีมงานช่วยจัดเตรียมเอกสาร และเตรียมยื่นเรื่องขออนุญาตปลูกสร้างกับหน่วยงานราชการ' },
    ...
    { id: 6, icon: <Hammer size={32} />, title: 'เริ่มก่อสร้างและชำระเงินตามงวดงาน', desc: 'ดำเนินงานก่อสร้างอย่างมีมาตรฐาน และลูกค้าชำระเงินตามงวดงานที่ตกลงไว้' },
