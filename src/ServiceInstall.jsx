    ...
    <div className="bg-gray-50 min-h-screen pb-32 font-sans">
      <div className="relative h-[400px] overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white px-4 space-y-4">
          <h1 className="text-5xl font-bold tracking-tight mb-2">บริการติดตั้งและต่อเติม</h1>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-6">
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20 text-[#001D4A]">
                  ...
                  >
                    ...
                    <div className="p-6 flex flex-col flex-grow">
                      ...
                      <div className="mt-auto">
                        <div className="inline-block bg-red-100 text-red-600 px-3 py-1 rounded-md text-xs font-bold mb-4">
                        ...
                        <div className="flex flex-col">
                          ...
                          <div className="flex items-baseline gap-1 text-[#001D4A]">
                            <span className="text-3xl font-[900] tracking-tight text-red-600">
